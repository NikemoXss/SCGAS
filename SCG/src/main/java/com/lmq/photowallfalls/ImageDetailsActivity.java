...
public class ImageDetailsActivity extends BaseActivity implements OnPageChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		array = b.getStringArray("image_url");
		int imagePosition = b.getInt("image_position", 0);
		...
		// 设定当前的页数和总页数
		pageText.setText((imagePosition + 1) + "/" + array.length);
	}
	...
	class ViewPagerAdapter extends PagerAdapter {
		...
		public Object instantiateItem(ViewGroup container, int position) {
			String imagePath = getImagePath(array[position]);
	...
	public void onPageSelected(int currentPage) {
		...
		pageText.setText((currentPage + 1) + "/" + array.length);
	}
