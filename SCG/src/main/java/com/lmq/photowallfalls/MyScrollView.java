package com.lmq.photowallfalls;
...
public class MyScrollView extends ScrollView implements OnTouchListener {
	...
	public void loadMoreImages() {
		if (hasSDCard()) {
			...
			if (startIndex < dimageUrls.length) {
//				Toast.makeText(getContext(), "正在加载...", Toast.LENGTH_SHORT).show();
				if (endIndex > dimageUrls.length) {
					endIndex = dimageUrls.length;
				}
...
//				Toast.makeText(getContext(), "已没有更多图片", Toast.LENGTH_SHORT).show();
	...
	class LoadImageTask extends AsyncTask<Integer, Void, Bitmap> {
		...
		protected Bitmap doInBackground(Integer... params) {
			...
			mImageUrl = dimageUrls[mItemPosition];
		...
		protected void onPostExecute(Bitmap bitmap) {
			if (bitmap != null) {
				...
				addImage(bitmap, columnWidth, 300);
			}
			...
			if (mImageView != null) {
				...
				imageView.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						Bundle b = new Bundle();
						b.putStringArray("image_url", dimageUrls);
						b.putInt("image_position", mItemPosition);
						intent.putExtras(b);
