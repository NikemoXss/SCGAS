...
public class LendMoneyActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tz_lendmoney);
	...
	protected void initViews() {
		...
		interest_rate_Editor = (EditText) findViewById(R.id.l_interest_rate);
		borrow_time_Editor = (EditText) findViewById(R.id.borrow_time);
		...
		rewrad_btn.setOnCheckedChangeListener(new oncheck(LendMoneyActivity.this));
		...
		pay_kind_sp2.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				// // borrow_time_Editor.setHint("借款期限:");
	...
	public void onClick(View arg0) {
		...
		case R.id.item_show_kind:
			...
			startActivity(new Intent(this, LendMoney_Choice_kindActivity.class));
			break;
		case R.id.back:
			finish();
			break;
