...
public class LoginActivity_Scg extends BaseActivity implements OnClickListener {
    ...
    EditTextWithDel login_zh_sx;
    EditText login_mm_sx;
    Button login_sx;
    String login_zh_sx_str, login_mm_sx_str;
    TextView title, forget_pwd_sx;
    ImageView iv, title_left1, isopen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login_mm_sx = (EditText) findViewById(R.id.login_mm_sx);
        isopen = (ImageView) findViewById(R.id.isopen);
        ...
        ZxAnimator(remember_ll, 400);
        ZxAnimator(login_ed_ll, 300);
...
//			startActivity(i);
            ...
            case R.id.isopen:
                if(isOPen){
                    login_mm_sx.setTransformationMethod(PasswordTransformationMethod.getInstance());
                    isopen.setBackgroundResource(R.drawable.close);
                    isOPen=false;
                }else {
                    login_mm_sx.setTransformationMethod(HideReturnsTransformationMethod.getInstance());
                    isopen.setBackgroundResource(R.drawable.open);
                    isOPen=true;
                }
                break;
