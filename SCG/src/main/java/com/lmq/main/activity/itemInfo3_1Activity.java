...
@SuppressLint("NewApi")
public class itemInfo3_1Activity extends BaseActivity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.tender_miaoshu:
			...
			abIntent.setClass(itemInfo3_1Activity.this, LMQWebViewActivity.class);
		...
		case R.id.sq:
			...
			if (item != null) {
				Intent info = new Intent(itemInfo3_1Activity.this, calculateActivity.class);
		...
		case R.id.enter:
			if (Default.userId == 0) {
				startActivity(new Intent(itemInfo3_1Activity.this, loginActivity.class));
			} else {
				...
				if (item.getBorrow_uid() == Default.userId) {
					...
					buyInten.setClass(itemInfo3_1Activity.this, itemInfo2_2Activity.class);
		...
		case R.id.tender_people:
			if (item != null) {
				Intent intent = new Intent(itemInfo3_1Activity.this, tzDetailsListActivity.class);
