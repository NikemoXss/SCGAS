...
public class AutoTenderActivity extends BaseActivity implements OnClickListener {
	...
	public void getAutolong() {
		...
		BaseHttpClient.post(getBaseContext(), Default.autolong, builder, new JsonHttpResponseHandler() {
	...
	public void uplaodAutolong() {
		...
		BaseHttpClient.post(getBaseContext(), Default.savelong, builder, new JsonHttpResponseHandler() {
