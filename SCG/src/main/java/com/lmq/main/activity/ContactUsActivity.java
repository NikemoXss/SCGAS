...
import com.lmq.main.util.ToQQ;
import com.lmq.view.ArcMenu;
...
public class ContactUsActivity extends BaseActivity implements OnClickListener, SensorEventListener {
    ...
    double baseLat1 = 31.766479;
    double baseLong1 = 119.954694;
    ...
    ArcMenu arcMenu;
    //君君，童谣，馨馨,薇薇
    String[] QQNum = new String[]{"1802038882", "1829208881", "1829518881", "1829178881"};
    String[] QQName = new String[]{"君君", "童谣", "馨馨", "薇薇"};
...
//				 startBlink(getLatLng(baseLat1 + "", baseLong1 + ""));
        ...
        arcMenu.setOnMenuItemClickListener(new ArcMenu.onMenuItemClickListener() {
            ...
            public void onclick(View view, int position) {
                // TODO Auto-generated method stub
                ToQQ.toQQ(ContactUsActivity.this, QQNum[position-1]);
