...
//		Log.e("mAreaDatasMap", mAreaDatasMap.toString());
		if (mCurrentAreaName.equals("")) {
...
//	     String res=result.getText().toString().trim();
	        ...
	        intent.putExtra("result", mCurrentProviceName + mCurrentCityName + mCurrentAreaName);
	        setResult(2,intent);
	        finish();
	}
}
