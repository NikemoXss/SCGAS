 ...
 * 绑定手机号码
 */
public class PeopleInfoUpdatePhone extends BaseActivity implements OnClickListener {
	...
	public void doHttp() {
		...
		BaseHttpClient.post(getBaseContext(), Default.peoInfoPhone, builder, new JsonHttpResponseHandler() {
	...
	public void doHttp2() {
		...
		BaseHttpClient.post(getBaseContext(), Default.peoInfoPhone2, builder, new JsonHttpResponseHandler() {
