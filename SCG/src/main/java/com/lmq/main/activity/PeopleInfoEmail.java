 ...
 * 绑定邮箱
 */
public class PeopleInfoEmail extends BaseActivity implements OnClickListener {
	...
	public void doHttp() {
		...
		BaseHttpClient.post(getBaseContext(), Default.peopleinfoEmail, builder, new JsonHttpResponseHandler() {
