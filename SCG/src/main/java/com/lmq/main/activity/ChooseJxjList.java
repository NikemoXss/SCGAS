...
import com.lmq.adapter.Jxj_tzAdapter;
...
public class ChooseJxjList extends BaseActivity implements OnClickListener {
	private PullToRefreshListView mListView;
	private Jxj_tzAdapter jxjAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				TextView tv_rate = (TextView) view.findViewById(R.id.rate_jxj);
				String cbid = tv_id.getText().toString();
				String cbrate = tv_rate.getText().toString();
				Intent intent = new Intent();
				intent.putExtra("return_cbid", cbid);
				intent.putExtra("return_cbrate", cbrate);
	...
	public void onClick(View v) {
		...
		case R.id.title_right:
			...
			intent.putExtra("return_cbrate", "00");
			setResult(RESULT_OK, intent);
			finish();
			break;
	...
	public void doHttp() {
		...
		// 填充参数
		BaseHttpClient.post(ChooseJxjList.this, Default.choosejxjList, builder, new JsonHttpResponseHandler() {
...
//				showCustomToast(json.toString());
	...
	protected void initJsonData(JSONObject json) {
		...
		try {
			...
			jxjAdapter = new Jxj_tzAdapter(ChooseJxjList.this, list);
			mListView.setAdapter(jxjAdapter);
			jxjAdapter.notifyDataSetChanged();
		} catch (JSONException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
