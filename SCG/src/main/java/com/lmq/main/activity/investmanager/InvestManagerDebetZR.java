...
public class InvestManagerDebetZR extends BaseActivity implements OnClickListener {
	...
	public void getDebetInfo() {
		...
		BaseHttpClient.post(getBaseContext(), Default.sellhtml, builder, new JsonHttpResponseHandler() {
	...
	private void buyDebetAction() {
		...
		BaseHttpClient.post(getBaseContext(), Default.sell_debt, builder, new JsonHttpResponseHandler() {
