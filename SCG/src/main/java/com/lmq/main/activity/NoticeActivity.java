...
public class NoticeActivity extends BaseActivity implements OnClickListener {
	...
	protected void initView() {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				Intent intent = new Intent(NoticeActivity.this, itemNewsActivity.class);
				Default.showNewsId = ((newsItem) Data.NoticeList.get(arg2 - 1)).getId();
	...
	class newsAdapter extends BaseAdapter {
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			}
			{
				...
				newsItem item = (newsItem) Data.NoticeList.get(arg0);
	...
	public void doHttp(JsonBuilder builder) {
		...
		BaseHttpClient.post(getBaseContext(), Default.notice, builder, new JsonHttpResponseHandler() {
