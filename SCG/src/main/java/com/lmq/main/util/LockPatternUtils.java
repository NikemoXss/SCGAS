...
public class LockPatternUtils {
	 ...
	 * attempt for it to be counted against the counts that affect {@link #FAILED_ATTEMPTS_BEFORE_TIMEOUT} and {@link #FAILED_ATTEMPTS_BEFORE_RESET}
	 */
	...
	private static class LockPatternFileObserver extends FileObserver {
		...
		public void onEvent(int event, String path) {
			MyLog.d(TAG, "file path" + path);
			if (LOCK_PATTERN_FILE.equals(path)) {
				MyLog.d(TAG, "lock pattern file changed");
