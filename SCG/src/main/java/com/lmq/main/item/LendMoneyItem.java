...
public class LendMoneyItem {
	...
	public String toString() {
		return "LendMoneyItem [statue=" + statue + ", id=" + id + ", title=" + title + ", amount=" + amount + ", repay_amount=" + repay_amount + ", interest_rate=" + interest_rate + ", repay_kind=" + repay_kind + ", repay_due_datae=" + repay_due_datae + ", repay_due_uint=" + repay_due_uint + ", kind=" + kind + "]";
	}
