...
public class CustomDetailView extends BaseActivity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String html = "<html><head><style type='text/css'>p{text-left: center;border-style:" + " none;border-top-width: 2px;border-right-width: 2px;border-bottom-width: 2px;border-left-width: 2px;}" + "img{height:auto;width: auto;width:100%;}</style></head><body>" + html_str + "</body></html>";
	...
	public void doHttp() {
		...
		// 填充参数
		BaseHttpClient.post(CustomDetailView.this, Default.bannerPicDetail, builder, new JsonHttpResponseHandler() {
	...
	private void addImageClickListner() {
		contentWebView.loadUrl("javascript:(function(){" + "var objs = document.getElementsByTagName(\"img\"); " + "for(var i=0;i<objs.length;i++)  " + "{" + "    objs[i].onclick=function()  " + "    {  " + "        window.imagelistner.openImage(this.src,i);  " + "    }  " + "}" + "})()");
	}
