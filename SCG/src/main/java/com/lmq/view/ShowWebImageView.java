...
public class ShowWebImageView extends BaseActivity implements OnPageChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for (int i = 0; i < mImageViews.length; i++) {
			CustomImageView imageView = new CustomImageView(this, imageArrayList.get(i));
