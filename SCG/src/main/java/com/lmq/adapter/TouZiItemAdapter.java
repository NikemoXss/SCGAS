...
public class TouZiItemAdapter extends BaseAdapter {

    private Context mContext;
    private List<Map<String, Object>> list;
    private LayoutInflater mInflater;

    public TouZiItemAdapter(Context mContext) {
        super();
        this.mContext = mContext;
        mInflater = LayoutInflater.from(mContext);
    }

    public TouZiItemAdapter(Context mContext, List<Map<String, Object>> list) {
        super();
        mInflater = LayoutInflater.from(mContext);
        this.mContext = mContext;
        this.list = list;
...
//        TextView new_tzy_yjnhll,bd_tzy_je,tv_tzy_je,bd_tzy_date,tv_tzy_date;
//        RoundProgressBar_Tz_Sx progress_tzy_scw;

        ViewHolder holder = null;
        if (convertView == null) {
            holder = new ViewHolder();
            convertView = mInflater.inflate(R.layout.item_list_tzfragment, null);
