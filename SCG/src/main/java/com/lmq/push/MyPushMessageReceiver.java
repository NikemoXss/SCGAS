...
public class MyPushMessageReceiver extends PushMessageReceiver {
	...
	public static final String MyTAG = "MyPushMessageReceiver";
...
//		updateContent(context, messageString);
	...
	public void onNotificationArrived(Context context, String title, String description, String customContentString) {
		...
		String notifyString = "通知到达 onNotificationArrived  title=\"" + title + "\" description=\"" + description
				+ "\" customContent=" + customContentString;
		Log.d(TAG, notifyString);
        Log.e("onNotificationArrived", notifyString);
...
//		updateContent(context, notifyString);
	...
	public void onNotificationClicked(Context context, String title, String description, String customContentString) {
		String notifyString = "通知点击 onNotificationClicked title=\"" + title + "\" description=\"" + description
				+ "\" customContent=" + customContentString;
		Log.d(TAG, notifyString);
		Log.e("onNotificationClicked", notifyString);
		// 自定义内容获取方式，mykey和myvalue对应通知推送时自定义内容中设置的键和值
		if (!TextUtils.isEmpty(customContentString)) {
			JSONObject customJson = null;
			try {
