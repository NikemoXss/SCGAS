...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	 ...
	 * to the end of the AdapterView. See ( {@link PullToRefreshAdapterViewBase#setOnLastItemVisibleListener}.
	 *
	 * @author Chris Banes
	 */
	...
	public static interface OnPullEventListener<V extends View> {
		 ...
		 *            the user is pulling. Only useful when <var>state</var> is {@link State#PULL_TO_REFRESH} or {@link State#RELEASE_TO_REFRESH}.
		 */
