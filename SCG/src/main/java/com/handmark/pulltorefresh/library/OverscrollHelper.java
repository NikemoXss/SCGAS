...
public final class OverscrollHelper {
	 ...
	 *            passed through from from overScrollBy call
	 * @param scrollRange
	 *            - Scroll Range of the View, specifically needed for
	 *            ScrollView
	 * @param isTouchEvent
	 *            - true if this scroll operation is the result of a
	 *            touch event, passed through from from overScrollBy call
	 ...
	 *            - Threshold for which the values how fuzzy we
